...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsFuturistic(ImGuiStyle* dst = NULL);   // Default
    IMGUI_API void          StyleColorsChristmas(ImGuiStyle* dst = NULL);   // Xmas Theme
    IMGUI_API void          StyleColorsHalloween(ImGuiStyle* dst = NULL);   // Halloween Theme
    ...
    // Customized Version
    IMGUI_API void          Im_Spinner(const char* label, float radius, float thickness, ImU32 color);
